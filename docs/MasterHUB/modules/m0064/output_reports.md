...
> **WARNING**
>
> Firmware updates can render the module inoperable. Only use official Cooler Master firmware packages in a power-controlled environment. See [recovery](./recovery.md) for restoring the module.
...
| Module | The M0 module to target. | Always `0x00` (`0`). |
| Index | The LED index to target. | Always `0x00` (`0`). |
...
Example: `02 2d 00 00 33 24 3f 01`
...
This output report causes the HID to output three messages on Channel 2 and one message on Channel 3.

For example:

* Channel 2, Message 1: `5f 5f 4c 44 56 45 52 5f 30 31 2e 30 30 2e 30 30 2e 30 30 00 ff ff ff ff ff ff ff ff ff ff ff ff 30 07 b1 bb 74 00 00 00 4c 8d 00 00 df 07 5a 29 18 f1 01 00 26 a0 d8 0a 5f 5f 41 50`
* Channel 2, Message 2: `56 45 52 5f 30 31 2e 30 30 2e 30 33 2e 30 30 00 00 00 00 00 00 00 00 00 00 00 00 00 fc eb 01 00 1d d8 7f 49 4d 48 44 44 30 31 41 41 32 32 31 32 34 32 34 30 30 31 38 38 00 00 00 00`
* Channel 2, Message 3: `00 00 00 00 00 00 00 00 14 00 00 00 c3 07 4c 0d 95 7c 03 00 c3 07 4c 0d 95 7c 03 00 aa 55 a5 5a`
* Channel 3, Message 1: `01 47 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00`

There appears to be some UTF-8 encoded data in the Channel 2 messages:

* `__LDVER_01.00.00.00������������0��tL��Z)�&��
__AP`
* `VER_01.00.03.00���IMHDD01AA221242400188`
* `�L
�|�L
�|�U�Z`
