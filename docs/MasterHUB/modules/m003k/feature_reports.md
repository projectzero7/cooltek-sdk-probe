...
Example: `2e 0f a7 df 5b 3f 30 31 2e 30 30 2e 30 35 2e 30 30 00`
...
Example: `2f 0f c1 9d 2b 90 30 31 2e 30 30 2e 30 34 2e 30 30`
...
Example: `30 14 4d 48 4b 42 30 33 41 41 32 32 31 32 34 33 33 30 30 33 38 37`
...
| Report length | The number of remaining bytes in the report. | Always `0x03` (`3`) |
| Knob 1 brightness | The current LED brightness for Knob 1. | Integers in the range `[0x00, 0x64]` (`[0, 100]`) |
| Knob 2 brightness | The current LED brightness for Knob 2. | Integers in the range `[0x00, 0x64]` (`[0, 100]`) |
| Knob 3 brightness | The current LED brightness for Knob 3. | Integers in the range `[0x00, 0x64]` (`[0, 100]`) |
...
| Report length | The number of remaining bytes in the report. | Always `0x03` (`3`) |
| Knob 1 mode | The current LED mode for Knob 1. | Any [lighting mode](../../lighting_modes.md) |
| Knob 2 mode | The current LED mode for Knob 2. | Any [lighting mode](../../lighting_modes.md) |
| Knob 3 mode | The current LED mode for Knob 3. | Any [lighting mode](../../lighting_modes.md) |

Example: `34 03 01 01 01`
...
Example: `36 10 b7 d3 e0 c7 c4 00 00 00 b8 f7 5d 01 c4 00 00 00`
